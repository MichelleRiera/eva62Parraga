...
a persistence unit "eva62ParragaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62Parraga/pom.xml":
...
artifact ("eva62Parraga.war") is already built. You can build
